...
(FR-6 Open-Meteo, FR-5 NWS, FR-7 SREF, SPC outlook). The engine consumes only the
normalized :class:`IngestBundle` / :class:`~upstreamwx.engine.models.HazardInputs`,
never a raw provider (FR-13).
"""
